...
class Warehouse:
    with open("/home/ubuntu/My_Project/AWS/Warehouse/WarehouseList.json", 'r', encoding='utf-8') as WL1:
        list_equipment = json.load(WL1)

    @staticmethod
    def default():
        with open("/home/ubuntu/My_Project/AWS/Warehouse/WarehouseList.json", 'w', encoding='utf-8') as WLw:
